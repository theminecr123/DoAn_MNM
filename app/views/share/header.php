                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <?php
                                    ...
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                        <?php
                                        if(isset($_SESSION['name'])){
                                            echo '<a href="../account/info" style="color: inherit; text-decoration: none;">' . $_SESSION['name'] . '|' . $_SESSION['role'] . '</a>';
                                            echo "<a class='btn btn-danger' href='../account/logout'>Đăng Xuất</a>";

                                    }
                                        ?>
                                    </span>
                                    <img width="50px" class="img-profile rounded-circle" src="/DoAn_MNM/public//images/undraw_profile.svg">
